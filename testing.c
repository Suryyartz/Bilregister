...
while(choice != Quit){
    ...
    case Add_vehicle:
     if (position >= Size) {
        ...
        FILE *file = fopen("C:\\Users\\abdal\\OneDrive\\Skrivbord\\Coding\\Lab2/registry.txt", "r");
         int current_line = 1;
        char c;
         do 
        {
        ...
        FILE *file = fopen("C:\\Users\\abdal\\OneDrive\\Skrivbord\\Coding\\Lab2/registry.txt", "a");
    ...
    case Show_registry: {
         FILE *file2 = fopen("C:\\Users\\abdal\\OneDrive\\Skrivbord\\Coding\\Lab2/registry.txt", "r");
         char buffer[255];
